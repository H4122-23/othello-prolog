...
play :-
  ...
  Turn = 0,
  play(Grid, x, d, 4, Turn),!.

play(Grid, Player, Alpha_last, Index_last, Turn):-
  ...
  playerInput(Grid, Alpha_last, Index_last, Alpha, Index, Player, Turn),
  makeAMove(Grid, Player, Index, Alpha, Turn).  %? always Match \w side effect Display
...
play(Grid, Player, Alpha_last, Index_last, Turn):-
  ...
  play(Grid, Player2, Alpha_last, Index_last, Turn).
...
% (test if Valid move)
makeAMove(Grid, Player, Index, Alpha, Turn) :-
  ...
  NewTurn is Turn + 1,
  play(Grid_out, NextPlayer, Alpha, Index, NewTurn).
...
makeAMove(Grid, Player, Index, Alpha, Turn) :-
  ...
  play(Grid, Player, Alpha, Index, Turn).



% let the system make the play or the user (defined by prompt:option/2)
playerInput(Grid, Alpha_last, Index_last, Alpha, Index, Player, _) :-
